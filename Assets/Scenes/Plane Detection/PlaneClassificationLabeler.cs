...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class PlaneClassificationLabeler : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            DisablePlane(m_ARPlane.classification == PlaneClassification.Table || m_ARPlane.classification == PlaneClassification.None);
        }
        ...
        void DisablePlane(bool show)
        {
            m_PlaneMeshRenderer.enabled = show;
            GetComponent<LineRenderer>().enabled = show;
            if (!show)
                m_TextMesh.color = new Color(0, 0, 0, 0);
        }
    }
}